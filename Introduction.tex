...
Our Universe's origin has always been a mystery until the last century, when humankind started looking for \attention{quantitative [people have been asking these questions for much longer than a century :-)]} answers to the unanswered questions about the evolution of the \st{Universe} \attention{cosmos [avoid repeating words]}. The \st{process of finding} \attention{search for} solutions \st{to problems that arose built up} \attention{led} to a field of study called cosmology. This field has drastically impacted our knowledge of the \st{universe} \attention{universe's} evolution~\citep{book:909085}. \st{The primordial humankind assumed}

\attention{[Break paragraph here because the following sentence fits more logically with the subsequent text.]} \attention{Humans initially believed} that the Sun, the moon, and other planets orbited the Earth until Nicolaus Copernicus and other astronomers replaced the geocentric model with the heliocentric model~\citep{sep-copernicus, kanas}. \st{The c}{\attention C}elestial mechanics \attention{emerged as an} area of study \st{came into existence} after Isaac Newton \st{made discoveries} \attention{discovered} that \st{the} elliptic\attention{al} planet motion\st{, among other things,} can be explained by gravitational force attraction. \st{He also reasoned that the Kepler ellipse is only an approximation of planetary motion's true nature (interaction between planets)}~\citep{crowe2013theories,sep-copernicus}. \attention{[I recommend removing the previous sentence since it doesn't really fit with the flow.]} In the modern study of the Universe, \attention{our understanding of gravity has been further refined by} Albert Einstein\attention{'s} \st{has been a significant influence on the} theory of general relativity, which presents the mathematical framework required to \st{explain} \attention{describe} the evolution of the universe \attention{[be consistent with capitalization: universe is usually not capitalized, so update the other instances throughout the text]}~\citep{1965ApJ...142..419P}.  \attention{[$\leftarrow$ No citation needed here for general relativity; Penzias and Wilson isn't a relevant reference for this statement anyway.]}
	
	As a result of all these findings \attention{[you haven't discussed ``these findings'' yet---discuss the discovery of the expanding universe and the CMB first, before introducing the big bang model]}, Georges Lemaitre proposed the Big Bang theory, the contemporary model that provides a complete explanation of the Universe expansion~\citep{1926ApJ....64..321H}. The Big Bang theory was established from Hubble's law and subsequently by Arno Penzias and Robert Wilson in 1964 from discovering the cosmic microwave background (CMB)~\citep{1965ApJ...142..419P,2003RvMP...75..559P,1929PNAS...15..168H}. The Supernova Cosmology Project and the High-Z Supernovae Search Team in 1998 \st{uncovered} \attention{discovered} the acceleration of the Universe\st{. They used} \attention{using observations of} type Ia supernovae \st{to determine the acceleration of the Universe}~\citep{1998AJ....116.1009R, 1999ApJ...517..565P}. The \st{Universe's} \attention{accelerated} expansion \st{acceleration} is described by \st{the} dark energy, \st{that} \attention{which} accounts for approximately 74 percent of the Universe's energy density. Today, \st{any dark energy discoveries are still as disconcerting in the study of} \attention{understanding the nature of dark energy is a major area of focus in} astrophysics and particle physics~\citep{2008ARA&A..46..385F}. \attention{[Don't use additional linebreaks (\textbackslash\textbackslash) after paragraphs.  Latex will take care of the appropriate spacing.]} \\ 
	
	\section{History of the Universe}
	
	\autoref{Fig:timeline} shows the cosmic history of the Universe. \st{, where the earliest era was the Planck era.} The \st{earliest} \attention{Planck} era\attention{, which lasted unil} \st{is from zero to} \SI{e-43}{s} \st{from the birth of the Universe.} \attention{after the big bang} \st{What happened before the Planck era} is unknown to physicists\st{; the only progress made was to build up from what was known from the birth of the Universe.} \attention{and requires a quantum} \st{Quantum} theory of gravity \st{provides the background to understand what happened before this time}~\citep{1981PhRvD..23..347G}. \st{What was deduced from} \attention{Following} the Planck era\attention{, \SI{e-34}{s} after the big bang, the universe went through a period of} \st{was the Universe's} rapid exponential expansion, \st{governed by the Epoch of} \attention{known as} Inflation. \st{It is $10^{-34}$s from the birth of the Universe}~\citep{Planck}. \attention{[Cite Guth for inflation, omit the Odenwald reference.]}
	...
	Recombination occurred when \attention{the universe cooled enough for} \st{the} neutral hydrogen (HI) \attention{to form, around} \st{was formed from the cool enough Universe at} a redshift of z $\sim1100$. \attention{[All variables should be in math mode, so put $z$ inside the dollar signs.]} The redshift-wavelength relation is \st{mathematically presented} \attention{[include a brief phrase here describing what redshift physically means, i.e. that higher redshift means earlier times] given} by
	\begin{equation}
	\begin{split}
	1+z & = \frac{\lambda_{obs}}{\lambda_{emit}}= \frac{1}{a}
	\end{split}
	\end{equation}
	where $z$ is the redshift, $\lambda_{obs}$ is the wavelength of the observed signal, $\lambda_{emit}$ is the wavelength of the signal emitted, and $a$ is the Universe expansion scale factor. \attention{[Merge this paragraph with the next one.]}
	
	\st{Before that} \attention{Prior to recombination}, electrons were not bound to protons, and the Universe contained ionized plasma known as photon-baryon fluid. Decoupled photons then formed the CMB. \st{The first instance of the CMB was observed by}~\citep{1965ApJ...142..419P}\st{after the era of recombination.} \attention{[You already discussed the discovery by Penzias and Wilson in the intro section, no need to repeat here.]}
%	The telescopes that braced the Big Bang theory were the Cosmic Background Explorer (COBE)~\citep{2004astro.ph..2528M}. 
	Subsequently, \st{the} HI became the dominant baryonic component of the intergalactic medium (IGM) \st{before the first stars' formation} during the dark ages ($1100 \gtrsim z \gtrsim 30$).  \attention{[The phrasing you had in the previous sentence made it sound like stars form during the dark ages, which isn't true.]}  \st{There was rapid cooling of gas relative to the CMB.} \attention{[Not really ``rapid.''  You'll discuss the gas cooling later, so you can omit this sentence here.]} \attention{No measurements of the dark ages exist, and if} \st{If the} hydrogen can be mapped in this era, valuable cosmological data can be produced~\citep{11, 2004PhRvL..92u1301L}. \attention{[Don't use additional linebreaks (\textbackslash\textbackslash) after paragraphs.  I won't explicitly call this out for future instances, so please do a full search/removal through the whole document.]} \\
	
	There were density fluctuations in the distribution of matter, and the overdense regions collapsed under the influence of gravity, ultimately creating the first stars. Thus, nuclear reaction resulted in Cosmic Dawn ($30\gtrsim z \gtrsim 10$). \st{An enormous emitted e}\attention{E}nergy from the \attention{first} stars \attention{ultimately fully} reionize\st{s}\attention{d [keep tenses consistent]} the Universe \st{causing ionization}. \st{This further results in stars exploding due to gravitational disintegration leading to the formation of galaxies. There is a decelerating effect in the Universe expansion due to gravity's force within dominating matter}~\citep{2017arXiv170808521D, 2012AdSpR..49..433B}. \attention{[Replace the last two sentences with a quick, generic statement that galaxies, clusters of galaxies, and large scale structure that exists in the present-day universe formed after the birth of the first stars---but please write this in your own words.]} \\
	
	Throughout the cosmological epochs, what is known is minimal because it is challenging to observe them directly. \st{Nevertheless, the new occurrence} \attention{The growth} of \SI{21}{cm} cosmology has \st{imparted} the capability \attention{to fill the gaps in our knowledge of the universe's} \st{of bridging the gap between what is known and what is not know about the eras of our} history~\citep{2014ApJ...782L...9V, 2013PhRvD..87d3002L}. \attention{[Cite the Pritchard 21cm cosmology in the 21st century paper here, not Voytek and Liu.]} A brief overview of the history of the Universe has been given, and the next section will cover \st{the} 21 cm cosmology \attention{corresponding to the} dark ages and cosmic dawn in more detail.
	...
	\st{Observations of redshifted 21 cm line of neutral hydrogen at radio frequencies are a rapidly growing area of cosmology research that can potentially shed light on numerous epochs in the Universe's history}~\citep{2012RPPh...75h6901P}. \attention{[Delete this sentence because it's redundant with the end of the last paragraph.]}
	
	\attention{Because} \st{Our Universe is rich in} hydrogen gas \attention{is the most abundant element in the universe}, \st{hence} \attention{there is} a concerted effort in the experimental community to develop telescopes for mapping neutral hydrogen via \SI{21}{cm} emission \st{wavelength line}. The \SI{21}{cm} wavelength of hydrogen gas is being observed by several experiments that are modeled for Hydrogen mapping in our Universe. \attention{[The previous sentence is out of place here and should be moved to the experimental section.]} This hydrogen line is an essential mechanism \st{as it helps in} \attention{for} probing the dark ages to the epoch of reionization (EoR)~\citep{2013PhRvD..87d3002L,2014ApJ...782...66P}. The generation of the hydrogen line (\SI{21}{cm} line or HI line) is due to the intrinsic spin\attention{s of the electron and proton within} \st{of} the hydrogen atoms\st{, namely, an electron and the proton}~\citep{book:832129}.  \attention{[Merge this paragraph with the next one.]} \\
	
	The electron and proton spins can be oriented in either the opposing or the same direction respective to each other. When \st{they} \attention{the spins} are \st{in an} opposing \st{direction, they result in an} \attention{or} antiparallel \st{spin}, \st{which implies that} the hydrogen atom is in the lower energy state. When \st{they} \attention{the spins} are \st{in the same direction, they result in a} parallel \st{spin}, \st{which implies that} the hydrogen atom is in a higher energy state. \st{Once} \attention{When} an electron transition\attention{s} from one state to another \attention{[photon is emitted only when the transition is from the higher to the lower state]}, the hydrogen atom discharges a photon with a \SI{21}{cm} wavelength\attention{,} equivalent to \st{(}\SI{1420}{MHz}\st{)}. The hyperfine splitting of the two energy states \attention{is} equivalent to \(\Delta E =  5.9 \times 10^{-6} \ eV\) \st{is a consequence of the dissimilarity between the spin states}. \autoref{Fig:21cm} shows the spin-flip transition process~\citep{16, book:832129}.
	
	\begin{figure}
		\begin{center}
			\includegraphics[width=0.5\linewidth]{Figures/Hydrogenemission1.jpeg}
			\caption{The formation of the \SI{21}{cm} wavelength line by the process of \attention{the} spin flip transition where the hydrogen atom moves from one energy state to another. Image credit: {Square Kilometre Array}.}
			\label{Fig:21cm}
		\end{center}
	\end{figure}
	
	\attention{The populations of the low- and high-energy spin states,} $n_0$ and $n_1$\attention{,} \st{are the two relative spin states that} define the spin temperature $T_s$\attention{:} \st{using the relation,}
	\begin{equation}
	\frac{n_0}{n_1} = \frac{g_1}{g_0}e^{(-E_10)/{k_B}{T_s}} = 3e^{{-T_*}{T_s}}\attention{.}
	\end{equation}
\attention{[Note the period at the end of the equation, and I removed the empty lines before and after the equation.  Don't put empty lines there; otherwise, you'll get an indent in the subsequent text.  I'll point out one more instance in the text below, but I'll leave it up to you to fix the rest.]}	\st{where} \attention{Here} $\frac{g_1}{g_0}/$ = 3 \attention{[extra slash in preceding math?]} is the spin degeneracy of the triplet and singlet levels, \st{$T_s$ is the spin temperature, which is the excitation temperature of the 21 cm hydrogen line} \attention{[you already defined the spin temperature above, no need to repeat here]}, and $T_{*}$ $\equiv$ hc/k $\lambda_{21cm}$ = 0.068 K \attention{[place all variables inside math mode, including $h,c,k$]} which is the equivalent temperature of the hyperfine splitting of the two energy levels \st{between the two states}~\citep{2012RPPh...75h6901P}.
	
	\begin{figure}
		\begin{center}
			\includegraphics[width=\linewidth]{Figures/epo.pdf}\\
			\caption{Frequency structure of the globally averaged 21 cm signal\st{,}\attention{:} (a) shows \attention{the spatial and temporal} \st{two dimensional slice of the time} evolution of the 21 cm brightness temperature and (b) shows \attention{the} predicted time evolution of the global\attention{ly averaged} 21 cm brightness temperature \st{with relevant epochs}~\citep{2012RPPh...75h6901P}. There are different physical processes that govern the four highlighted (A to D) periods and the details are discussed in the main text.}
			
%			Time evolution of the 21 cm signal. (a) Simulated 21 cm brightness temperature flactuations from the beginning of dark ages through the end of the reioization epoch. Coloration indicates the strength of the 21 cm brightness as it evolves through two absorption phases during the dark ages and the cosmic dawn and the emission phase during the EoR before the signal disappear after the IGM has been ionized. (b)spatially averaged signal as a function of redshift.
	...
	The cosmic dark ages lie between recombination and cosmic dawn, beginning $\sim380,000$ years after the big bang and ending a few tens of million years later ($1100 > z > 30$),~\citep{2014arXiv1412.2096J} \attention{[no need for a citation here]} during which there were no luminous sources. The cosmic dark ages possess distinctive features that have never been explored to date. 
	
	
	\attention{***} The 21 cm brightness temperature\attention{,} \st{relative to CMB (}$\delta$$T_b$\st{)}, \st{which provides a source of external 21 cm radiation}, depends on \st{the three sources, namely} the kinetic gas temperature, $T_K$, which characterizes the thermal motion of atoms in the gas, the hydrogen spin temperature ($T_S$) which is the excitation temperature of the 21 cm line, and the coupling between $T_S$ and $T_K$ (which arises from different mechanisms)~\citep{2015aska.confE...1K,2006PhR...433..181F}. \attention{[Rearrange this text so that the definition and explanation of the equation comes first.  The brightness temperature depends directly on $x_{HI}$, $z$, $T_S$, and $T_{CMB}$, but $T_S$ is heavily influenced by $T_K$ and the various coupling mechanisms.  So the opening sentence of this paragraph should come only after you've introduced the equation.]} The equation  
	
	\begin{equation}
	\delta{T_b}\propto {x_{HI}}(1+z)^{1/2}({T_s}-{T_{CMB}})/{T_s}
	\end{equation}
	
	\attention{[Here's another example of where you should remove the empty lines before and after the equation.  I won't call out the other instances, so please make sure to check the rest of your equations.]} relates $\delta$$T_b$ to important factors which are \(x_{HI}\), the fraction of neutral hydrogen, redshift ($z$) and two temperatures, the spin temperature ($T_s$) and the CMB temperature ($T_{CMB}$).
	
	\attention{[In the sections below, refer to the labeled periods in Figure~\ref{Fig:epochs} to guide your discussion.]} \\
	
	Figure~\ref{Fig:epochs} describes the physical processes that are responsible for the frequency structures we see in the evolution of the sky-averaged 21 cm brightness temperature. \attention{*** [All the text between the red asterisks should be moved to the end of the previous section.  You want to introduce the brightness temperature and the global signal before you start discussing the specific epochs.]} Region A highlighted in green explains the period where the free electrons were no longer present. During this epoch right after recombination $T_K$=$T_\gamma$=$T_S$ where $T_\gamma$ is the temperature of the neighbouring bath of radio photons, typically set by the CMB so that $T_\gamma$ = $T_{CMB}$. During this period, matter that had separated from the CMB was cooled adiabatically as the Universe expanded, which led to $T_K$ decreasing below $T_\gamma$~\citep{2006PhR...433..181F}. The CMB flux must have been resonantly absorbed by the cosmic neutral hydrogen through its spin-flip 21 cm transition before the first stars formed. $T_S$ is coupled to $T_K$ as the collision between hydrogen atoms becomes initially effective, resulting in $\delta T_b$ decreasing initially. As the Universe expands and collisional coupling becomes ineffective, $T_S$ reverts to $T_\gamma$ because of CMB absorption.
