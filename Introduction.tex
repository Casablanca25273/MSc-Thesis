...
\attention{[Similarly to my comment in the abstract, include 1--2 sentences here introducing ALBATROS and PRIZM as the experiments that will be the focus of your thesis, and give a quick summary of the science goals.  Without that intro, the next chapter will be confusing because it's hard to tell if you're talking about global signal measurements, imaging, or both.]}
